...
class loginController{
    ...
    async cadastrar(req, resp){
        ...
        if(req.body.nome != "" && req.body.email != "" && req.body.senha != "" && req.body.cpf != "" && req.body.rg != "" && req.body.sexo != "" && req.body.telefone != "" && 
            ...
            let doador = new DoadorModel(0, req.body.nome, req.body.email, req.body.senha, req.body.cpf, req.body.rg, req.body.sexo, 
                req.body.telefone, req.body.endereco, req.body.cep
            );
